...
当前版本为 **0.10.1：文档设置界面优化**。保留 0.10.0 的 PDF 智能取文、多语言文本整理与实验性日语注音，并让相关设置默认显示、统一对齐；不改变 Paddle 模型或 Debian 10 / glibc 2.28 兼容基线。
...
0.10.1 基线通过了 93 项 Python 测试和 52 项前端测试；布局检查新增文档设置默认展开与对齐断言。Windows/Linux 冻结 sidecar、真实模型推理、AppImage 与 NSIS 安装包仍由 GitHub Actions 和目标电脑完成最终验证。
